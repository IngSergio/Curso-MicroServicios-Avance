package mx.spm.servicio.items.controller;
...
public class ItemController {
	...
	// Para usar el servicio de Feign cambiar en @Qualifier por 'serviceFeign'
	// Para usar RestTemplate cambiar a 'serviceRestTemplate'
	@Autowired
